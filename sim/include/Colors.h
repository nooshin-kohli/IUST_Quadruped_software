...
static constexpr float windows2000[] = {220.f / 256.f, 234.f / 256.f, 242.f / 256.f};
static constexpr float terrainColor[] = {247.f / 256.f, 138.f / 256.f, 21.f / 256.f};
...
static constexpr float defaultRobotColor[] = {1.0f, 1.0f, 1.0f};
