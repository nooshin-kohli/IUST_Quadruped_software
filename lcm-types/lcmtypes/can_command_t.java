...
public final class can_command_t implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x80d6a48a21130a32L;
    ...
    {
        if (classes.contains(lcmtypes.can_command_t.class))
            return 0L;
 
        classes.add(lcmtypes.can_command_t.class);
    ...
    public can_command_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public can_command_t(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.can_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.can_command_t o = new lcmtypes.can_command_t();
    ...
    public lcmtypes.can_command_t copy()
    {
        lcmtypes.can_command_t outobj = new lcmtypes.can_command_t();
