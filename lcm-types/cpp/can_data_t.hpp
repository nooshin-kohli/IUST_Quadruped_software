...
#ifndef __can_data_t_hpp__
#define __can_data_t_hpp__
...
int can_data_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_data_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int can_data_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t can_data_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* can_data_t::getTypeName()
{
    return "can_data_t";
}

int can_data_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_data_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int can_data_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t can_data_t::_computeHash(const __lcm_hash_ptr *)
{
