...
#ifndef __can_command_t_hpp__
#define __can_command_t_hpp__
...
int can_command_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_command_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int can_command_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t can_command_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* can_command_t::getTypeName()
{
    return "can_command_t";
}

int can_command_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_command_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int can_command_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t can_command_t::_computeHash(const __lcm_hash_ptr *)
{
