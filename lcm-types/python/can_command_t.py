...
class can_command_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(can_command_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != can_command_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return can_command_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if can_command_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if can_command_t._packed_fingerprint is None:
            can_command_t._packed_fingerprint = struct.pack(">Q", can_command_t._get_hash_recursive([]))
        return can_command_t._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", can_command_t._get_packed_fingerprint())[0]
